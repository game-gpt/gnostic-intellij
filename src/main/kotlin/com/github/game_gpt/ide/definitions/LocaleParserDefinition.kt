...
import com.github.game_gpt.ide.file.GnosticLocaleFile
...
class LocaleParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticLocaleFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticLocaleLanguage)
    }
}