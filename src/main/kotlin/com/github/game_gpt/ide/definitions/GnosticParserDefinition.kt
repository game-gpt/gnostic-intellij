...
import com.github.game_gpt.ide.file.GnosticCodeFile
...
class GnosticParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticCodeFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticLanguage)
    }
}
