...
import com.github.game_gpt.ide.file.GnosticAssetFile
...
class AssetParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticAssetFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticAssetLanguage)
    }
}
