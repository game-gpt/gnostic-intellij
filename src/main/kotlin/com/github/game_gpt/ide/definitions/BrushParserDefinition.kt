...
import com.github.game_gpt.ide.file.GnosticBrushFile
...
class BrushParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticBrushFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticBrushLanguage)
    }
}
