...
import com.github.game_gpt.ide.file.GnosticScriptFile
...
class ScriptParserDefinition : ParserDefinition {
    ...
    override fun createParser(project: Project): PsiParser {
        return ValkyrieParser(ValkyrieLanguageConfig())
    }
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticScriptFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticScriptLanguage)
    }
}
