...
class ShaderParserDefinition : ParserDefinition {
    ...
    override fun createParser(project: Project): PsiParser {
        return ValkyrieParser(ValkyrieLanguageConfig(supportShaderExtension = true))
    }
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticShaderFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticShaderLanguage)
    }
}
