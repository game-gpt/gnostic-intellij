...
import com.github.game_gpt.ide.file.GnosticSkeletonFile
...
class SkeletonParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticSkeletonFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticSkeletonLanguage)
    }
}