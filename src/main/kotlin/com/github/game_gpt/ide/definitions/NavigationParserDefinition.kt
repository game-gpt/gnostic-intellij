...
import com.github.game_gpt.ide.file.GnosticNavigationFile
...
class NavigationParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticNavigationFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticNavigationLanguage)
    }
}
