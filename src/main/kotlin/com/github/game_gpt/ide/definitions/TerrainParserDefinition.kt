...
import com.github.game_gpt.ide.file.GnosticTerrainFile
...
class TerrainParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticTerrainFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticTerrainLanguage)
    }
}
