...
import com.github.game_gpt.ide.file.GnosticMeshFile
...
class MeshParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticMeshFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticMeshLanguage)
    }
}