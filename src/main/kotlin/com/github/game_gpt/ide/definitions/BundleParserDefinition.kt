...
import com.github.game_gpt.ide.file.GnosticBundleFile
...
class BundleParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticBundleFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticBundleLanguage)
    }
}
