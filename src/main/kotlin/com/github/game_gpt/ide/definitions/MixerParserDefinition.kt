...
import com.github.game_gpt.ide.file.GnosticMixerFile
...
class MixerParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticMixerFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticMixerLanguage)
    }
}
