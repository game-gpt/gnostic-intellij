...
import com.github.game_gpt.ide.file.GnosticAnimationFile
...
class AnimationParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticAnimationFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticAnimationLanguage)
    }
}