...
import com.github.game_gpt.ide.file.GnosticMetaFile
...
class MetaParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticMetaFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticMetaLanguage)
    }
}
