...
import com.github.game_gpt.ide.file.GnosticPrefabFile
...
class PrefabParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticPrefabFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticPrefabLanguage)
    }
}