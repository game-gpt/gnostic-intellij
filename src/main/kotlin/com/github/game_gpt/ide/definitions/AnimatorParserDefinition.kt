...
import com.github.game_gpt.ide.file.GnosticAnimatorFile
...
class AnimatorParserDefinition : ParserDefinition {
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return GnosticAnimatorFile(viewProvider)
    }
    ...
    companion object {
        val FILE = IFileElementType(GnosticAnimatorLanguage)
    }
}